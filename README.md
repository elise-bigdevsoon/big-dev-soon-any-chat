...
![Any Chat Project preview image](https://github.com/elise-bigdevsoon/big-dev-soon-any-chat/blob/main/project-preview.png)
...
1. Head over to the [project page](https://app.bigdevsoon.me/projects/any-chat). Choose between Freerun or Speedrun mode, then click either the "Start Freerun" or "Start Speedrun" button.
